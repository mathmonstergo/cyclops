...
| [cyclops-document-parser-contracts.md](./cyclops-document-parser-contracts.md) | Project-specific MinerU/parser and persistent import-worker contracts | Modifying parse jobs, worker lifecycle, MinerU normalization, evidence retention, or document chunk source fields |
...
| [cyclops-retrieval-contracts.md](./cyclops-retrieval-contracts.md) | Project-specific canonical hybrid retrieval and evaluation v2 contracts | Modifying retrieval services, callers, parent context, KG debug, or evaluation run storage |
